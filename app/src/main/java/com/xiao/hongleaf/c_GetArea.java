...
public class c_GetArea 
{
	...
	{  
		...
		System.out.println("��ͬԪ����:"+iSameIndex);
		System.out.println("ͼƬ���:"+iNumber);
		System.out.println("�ü�ͼƬ�Ŀ�:"+iw);
		System.out.println("�ü�ͼƬ�ĸ�:"+ih);
		System.out.println("Rect����ʼ��:"+iMarkI_start);
		System.out.println("Rect��������:"+iMarkI_end);
		
		iRectPix=(int)(dbAverage*(iMarkI_end-iMarkI_start));
		System.out.println("rect���:"+iRectPix);
		return iRectPix;
	}
	//��¼���ص�
